...
class Interceptor extends \SwiftOtter\OrderExport\Console\Command\OrderExport implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\SwiftOtter\OrderExport\Model\HeaderDataFactory $headerDataFactory, \SwiftOtter\OrderExport\Action\CollectOrderData $collectOrderData, \SwiftOtter\OrderExport\Action\ExportOrder $exportOrder, \Magento\Sales\Api\OrderRepositoryInterface $orderRepository, ?string $name = null)
    {
        $this->___init();
        parent::__construct($headerDataFactory, $collectOrderData, $exportOrder, $orderRepository, $name);
    }
