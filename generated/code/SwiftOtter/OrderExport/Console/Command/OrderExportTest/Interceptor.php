<?php
namespace SwiftOtter\OrderExport\Console\Command\OrderExportTest;

/**
 * Interceptor class for @see \SwiftOtter\OrderExport\Console\Command\OrderExportTest
 */
class Interceptor extends \SwiftOtter\OrderExport\Console\Command\OrderExportTest implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\SwiftOtter\OrderExport\Model\ResourceModel\OrderExportDetails\CollectionFactory $orderExportDetailsCollectionFactory, \SwiftOtter\OrderExport\Api\OrderExportDetailsRepositoryInterface $exportDetailsRepository, ?string $name = null)
    {
        $this->___init();
        parent::__construct($orderExportDetailsCollectionFactory, $exportDetailsRepository, $name);
    }
